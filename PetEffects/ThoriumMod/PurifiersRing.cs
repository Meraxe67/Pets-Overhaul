...
{
    public sealed class PurifiersRing : ModPlayer
    {
    ...
    public sealed class PurifiersRingItem : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if (!ModManager.ThoriumMod.InternalNameToModdedItemId.ContainsKey("PurifiersRing"))
            {
                return false;
            }

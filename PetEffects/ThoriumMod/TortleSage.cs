...
{
    public sealed class TortleSage : ModPlayer
    {
    ...
    public sealed class TortleScute : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if (!ModManager.ThoriumMod.InternalNameToModdedItemId.ContainsKey("TortleScute"))
            {
                return false;
            }

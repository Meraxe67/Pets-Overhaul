...
{
    public sealed class ResearchProbe : ModPlayer
    {
    ...
    public sealed class AlienResearchNotes : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if (!ModManager.ThoriumMod.InternalNameToModdedItemId.ContainsKey("AlienResearchNotes"))
            {
                return false;
            }

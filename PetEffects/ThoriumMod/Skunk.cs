...
{
    public sealed class Skunk : ModPlayer
    {
    ...
    public sealed class AromaticBiscuit : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if (!ModManager.ThoriumMod.InternalNameToModdedItemId.ContainsKey("AromaticBiscuit"))
            {
                return false;
            }

...
{
    public sealed class LilNecromancer : ModPlayer
    {
    ...
    public sealed class GuildsStaff : GlobalItem
    {
        public override bool AppliesToEntity(Item entity, bool lateInstantiation)
        {
            ...
            if (!ModManager.ThoriumMod.InternalNameToModdedItemId.ContainsKey("GuildsStaff"))
            {
                return false;
            }
